...
func removeDir(path string, m *mount.SafeFormatAndMount) error {
	klog.V(4).Infof("removeDir  %s", path)
	if proxy, ok := m.Interface.(mounter.CSIProxyMounter); ok {
